...
<body>
                         ...
                         <tr class="tab">
                            ...
                            <?php
                               ...
                               while($fetch=mysqli_fetch_assoc($result)){
                                $query2="SELECT b_name FROM `action` where id=$fetch[book_id]";
                                $result2=mysqli_query($con,$query2);
                                $fetch2=mysqli_fetch_array($result2)[0];
                                ...
                                <button onclick="confirm_delete($fetch[id],$fetch[book_id])" class="btn  btn-danger"><i class="bi bi-trash"></i></button>
                                </td>
                            </tr>
                            print;
            ...
            <table  class=" table table-hover text-center">
                         <tr class="tab">
                            ...
                            <?php
                               ...
                               $result=mysqli_query($con,$query);
                               while($fetch=mysqli_fetch_assoc($result)){
                                $query2="SELECT b_name FROM `fiction` where id=$fetch[book_id]";
                                $result2=mysqli_query($con,$query2);
                                $fetch2=mysqli_fetch_array($result2)[0];
                                ...
                                <button onclick="confirm_delete1($fetch[id],$fetch[book_id])" class="btn  btn-danger"><i class="bi bi-trash"></i></button>
                                </td>
                            </tr>
                            print;
    ...
    <script>
                        ...
                        function confirm_delete1(comfiction,book_id){

                            if(confirm("Are you sure you want to delete?")){
                                window.location.href="edit.php?comfiction="+comfiction+"&book_id="+book_id;
                            }
                        }
                        </script>
                          <script>
                        function confirm_delete(comaction,book_id){

                            if(confirm("Are you sure you want to delete?")){
                                window.location.href="edit.php?comaction="+comaction+"&book_id="+book_id;
                            }
                        }
