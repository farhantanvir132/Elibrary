    ...
    <div class="colm-2">
      ...
      <div class="price-row">
        <div class="price-col">
          ...
          <button type="submit" id="done-btn" >Extend</button>

        </div>
        <div class="price-col">
          <p>Advanced</p>
          <h3>40$ <span>/month</span></h3>
          <button type="submit" id="done-btn2" >Extend</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="wrapper-listen">
    <div id="popup-listen">
      ...
      <form id="payment-form" method="post"action="profile.php">
        ...
        <button type="submit" name="extend7">Pay</button>
  ...
  <div id="wrapper-listen">
    <div id="popup-listen2">
      ...
      <form id="payment-form" method="post" action="profile.php">
        ...
        <input type="text" id="account-number" required>
        <label for="amount">Amount:</label>
        <input type="text" id="amount" name="amount1" required>
        <button type="submit"name="extend30">Pay</button>
        <button type="reset" >Clear</button>
      </form>
    </div>
  </div>
