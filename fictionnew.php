...
?>
      ...
      <span></span>
                ...
                <br>
                <br>
                <h1 class="action" style="text-align:right; font-size: 36px; font-weight: bold; text-transform: uppercase; text-shadow: 2px 2px 4px #000000; letter-spacing: 2px;margin-bottom:50px;margin-top:128px;margin-right:185px;margin-left:260px">FICTION<hr></h1> 
  <div class="category">
  <?php
