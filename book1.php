...
<body>
  ...
  <div class="buttn">
    <?php
    echo "<a href='pdfreader.php?id=$fetch[id]'><button  class='button1'><i class='bi bi-book-half'></i> Start Reading</button></a>";
...
?>
  ...
  <div class="desc">
    <div class="colm1">
      ...
      $email = "$_SESSION[email]";
      $book_id = $fetch['id'];
      $query5 = "SELECT * FROM `addtofvt` where email='$email' and book_id='$book_id'";
      ...
      <form method="post" action="insert1.php">
        ...
        if (!isset($fetch5['exist']) || $fetch5['exist'] == 0) {
          echo <<<print
  <button type="submit"name="fvt" class="button2">
  ...
  print;
          ...
          $fvtid = $fetch5['id'];
          echo <<<print
                    <button type="submit"class="button2" name="added">
  ...
  print;
    ...
    <div class="colm2">
      ...
      <h3>Language</h3>
      <?php echo "<p>$fetch[lang]</p>"; ?>
      <h3>Year</h3>
      <?php echo "<p>$fetch[year]</p>"; ?>
      <h3>Catagory</h3>
      <?php echo "<p>$fetch[Catagory]</p>"; ?>
    </div>
    ...
    <div class="comment-section">
      ...
      if (isset($_SESSION['status']) && $_SESSION['status'] == 1 && isset($_SESSION['email'])) {
        ...
        echo <<<print
                      ...
                      <button type="submit"class="post" name="action" value="post">Post</button>
                      <button type="submit"class="post" name="action" value="edit" style="display:none;">Edit</button>
                      </form>
                      print;
      }
      ?>
  ...
  <script>
    function confirm_delete(id, book_id) {
      ...
      if (confirm("Are you sure you want to delete?")) {
        window.location.href = "edit.php?idcomfic=" + id + "&book_id=" + book_id;
      } else {
