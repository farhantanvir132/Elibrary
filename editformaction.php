...
<body>
    ...
    <?php
        $query = "SELECT * FROM `action` WHERE id=$_GET[id]";
...
<div class="form-group">
 <label for="description">Description</label>
  <textarea name="description"class="form-control">$fetch[description]</textarea>
</div>
<br>
<div class="form-group">
...
<input type="submit" name="update1" Value="Save" class="btn1">
</form>
</div>
</div>
print;
